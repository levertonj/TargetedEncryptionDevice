...
unsigned char plaintext_A[2048] __attribute__ ((section (".incoming_memory"), aligned(4)));
unsigned char encrypted_A[2048] __attribute__ ((section (".outgoing_memory"), aligned(4)));
unsigned char decrypted_A[2048] __attribute__ ((section (".incoming_memory"), aligned(4)));

unsigned char plaintext_B[2048] __attribute__ ((section (".incoming_memory"), aligned(4)));
unsigned char encrypted_B[2048] __attribute__ ((section (".outgoing_memory"), aligned(4)));
unsigned char decrypted_B[2048] __attribute__ ((section (".incoming_memory"), aligned(4)));
