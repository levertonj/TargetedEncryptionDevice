...
# Memory: black_to_red_memory
MEM_0 := TEDv3_architecture_black_to_red_memory
$(MEM_0)_NAME := black_to_red_memory
...
$(MEM_0)_END := 0x0200c34f
$(MEM_0)_SPAN := 0x0000c350
$(MEM_0)_HIERARCHICAL_PATH := black_to_red_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: black_to_red_memory
black_to_red_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: descriptor_mem
MEM_1 := TEDv3_architecture_descriptor_mem
...
$(MEM_1)_END := 0x0000400f
$(MEM_1)_SPAN := 0x00004010
...
# Memory: heap_stack
MEM_2 := TEDv3_architecture_heap_stack
$(MEM_2)_NAME := heap_stack
...
$(MEM_2)_START := 0x00028000
$(MEM_2)_END := 0x0002ce1f
$(MEM_2)_SPAN := 0x00004e20
$(MEM_2)_HIERARCHICAL_PATH := heap_stack
$(MEM_2)_WIDTH := 32
...
.PHONY: heap_stack
heap_stack: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: instruction_memory
MEM_3 := TEDv3_architecture_instruction_memory
$(MEM_3)_NAME := instruction_memory
...
$(MEM_3)_START := 0x00100000
$(MEM_3)_END := 0x0012bf1f
$(MEM_3)_SPAN := 0x0002bf20
$(MEM_3)_HIERARCHICAL_PATH := instruction_memory
$(MEM_3)_WIDTH := 32
$(MEM_3)_HEX_DATA_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: instruction_memory
instruction_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: red_to_black_memory
MEM_4 := TEDv3_architecture_red_to_black_memory
$(MEM_4)_NAME := red_to_black_memory
...
$(MEM_4)_START := 0x01000000
$(MEM_4)_END := 0x0100c34f
$(MEM_4)_SPAN := 0x0000c350
$(MEM_4)_HIERARCHICAL_PATH := red_to_black_memory
$(MEM_4)_WIDTH := 32
$(MEM_4)_HEX_DATA_WIDTH := 32
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: red_to_black_memory
red_to_black_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym
