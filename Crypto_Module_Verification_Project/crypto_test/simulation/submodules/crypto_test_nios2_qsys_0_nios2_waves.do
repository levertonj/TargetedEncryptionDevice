add wave -noupdate -divider {crypto_test_nios2_qsys_0: top-level ports}
...
add wave -noupdate -divider {crypto_test_nios2_qsys_0: common}
...
add wave -noupdate -divider {crypto_test_nios2_qsys_0: breaks}
