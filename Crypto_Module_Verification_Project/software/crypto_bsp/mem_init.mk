...
MEM_0 := crypto_test_incoming_memory
$(MEM_0)_NAME := incoming_memory
...
$(MEM_0)_HIERARCHICAL_PATH := incoming_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: incoming_memory
incoming_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: instruction_memory
MEM_1 := crypto_test_instruction_memory
$(MEM_1)_NAME := instruction_memory
...
$(MEM_1)_END := 0x000b0d3f
$(MEM_1)_SPAN := 0x00030d40
$(MEM_1)_HIERARCHICAL_PATH := instruction_memory
$(MEM_1)_WIDTH := 32
...
instruction_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: outgoing_memory
MEM_2 := crypto_test_outgoing_memory
$(MEM_2)_NAME := outgoing_memory
...
$(MEM_2)_END := 0x00007fe3
$(MEM_2)_SPAN := 0x00003fe4
$(MEM_2)_HIERARCHICAL_PATH := outgoing_memory
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: outgoing_memory
outgoing_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: stack_heap
MEM_3 := crypto_test_stack_heap
$(MEM_3)_NAME := stack_heap
...
$(MEM_3)_END := 0x00003fff
$(MEM_3)_SPAN := 0x00004000
$(MEM_3)_HIERARCHICAL_PATH := stack_heap
$(MEM_3)_WIDTH := 32
...
.PHONY: stack_heap
stack_heap: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
