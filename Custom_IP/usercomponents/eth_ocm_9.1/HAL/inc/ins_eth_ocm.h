...
typedef struct{
    ...
    alt_u32         base;       // base address of eth_ocm instance
    alt_u32         phyadd;     // PHY address on MDIO bus
    alt_u32         clk_div;    // MDIO clock divider value
    eth_ocm_regs    *regs;      // register table pointer
    alt_u8          irq;        // IRQ number
    char            name[20];   // Name of this instance
    eth_ocm_info    *info;      
} eth_ocm_dev;
